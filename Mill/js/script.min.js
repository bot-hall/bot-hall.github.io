...
//! auth
function(){let t,o,n,r,i,s,c=document.querySelector(".unknown-user"),d=document.querySelector(".auth__wrapper"),u=document.querySelector(".menu__mobile-unregistered"),p=document.querySelector(".personal__wrapper"),m=document.querySelector(".menu__icon"),y=document.querySelector(".menu__mobile-modal"),f=document.querySelector(".auth__wrapper-checkout"),_=document.querySelector(".number__container"),g=document.querySelector(".code__container"),b=document.querySelector(".code__container-text"),h=document.querySelector(".refresh-form"),v=document.querySelector("#custom-modal"),w=document.querySelector("body");if(document.querySelector("#infoAvailability")){let e=document.querySelector(".modal__inform-capcha");document.querySelector(".modal__inform").addEventListener("submit",t=>{if(t.preventDefault(),""==e.value){let e=document.querySelector(".modal__inform-name").value,t=document.querySelector(".modal__inform-main-body");!function(e){$.ajax({url:"index.php?route=product/product/stockStatusReport",type:"post",data:e,dataType:"json",beforeSend:function(){document.querySelector(".spinner-inform-continer").style.display="flex"},success:function(e){document.querySelector(".spinner-inform-continer").style.display="none",document.querySelector(".modal__inform-main-body").style.display="none",document.querySelector(".modal__inform-success-body").style.display="flex"},error:function(e){throw document.querySelector(".spinner-inform-continer").style.display="none",document.querySelector(".modal__inform-main-body").style.display="none",document.querySelector(".modal-availability-error").style.display="block",new Error(e)}})}({user_name:e,product_id:t.querySelector(".card__description-size").getAttribute("data-confirm"),size:t.querySelector(".card__description-size").textContent})}}),$("#infoAvailability").on("hidden.bs.modal",(function(e){document.querySelector(".modal__inform-main-body").style.display="block",document.querySelector(".modal__inform-success-body").style.display="none",document.querySelector(".modal__inform-name").value="",document.querySelector(".modal__inform-email").value=""}))}if(c&&(u.addEventListener("click",e=>{"none"==getComputedStyle(d).display?(y.classList.toggle("active-modal"),p.classList.toggle("show-effect"),v.classList.toggle("show-modal")):(y.classList.toggle("active-modal"),d.classList.toggle("show-effect"),v.classList.toggle("show-modal"))}),c.addEventListener("click",e=>{"none"==getComputedStyle(d).display?(p.classList.toggle("show-effect"),v.classList.toggle("show-modal"),w.classList.toggle("body-not-scroll"),l()):(d.classList.toggle("show-effect"),v.classList.toggle("show-modal"),w.classList.toggle("body-not-scroll"),l())})),c&&document.addEventListener("click",(function(e){if("none"==getComputedStyle(d).display){let t=e.target,o=t==p||p.contains(t),n=t==c,r=p.classList.contains("show-effect");o||n||!r||e.target.classList.contains("menu__mobile-unregistered")||(p.classList.toggle("show-effect"),v.classList.toggle("show-modal"),w.classList.toggle("body-not-scroll"),l())}else{let t=e.target,o=t==d||d.contains(t),n=t==c,r=d.classList.contains("show-effect");o||n||!r||e.target.classList.contains("menu__mobile-unregistered")||(d.classList.toggle("show-effect"),v.classList.toggle("show-modal"),w.classList.toggle("body-not-scroll"),l())}})),c||f){let e=document.getElementById("numberForm");i=e.getElementsByTagName("input");let l=document.getElementById("codeForm");t=l.getElementsByTagName("input");let u=document.querySelector(".spinner-number");document.querySelector(".back-number").addEventListener("click",e=>{_.style.display="block",g.style.display="none",document.querySelector(".send-tel").removeAttribute("disabled"),document.querySelector(".send-code-btn").removeAttribute("disabled"),clearTimeout(r),h.style.display="none",document.querySelector(".code-error-block").textContent="",f&&(document.querySelector(".code__container-title-error").style.display="none",t[0].parentNode.style.display="flex",t[0].value="",i[0].value=""),S()}),h.addEventListener("click",e=>{S(),setTimeout(()=>q(o,u,i[0]),400),clearTimeout(r),h.style.display="none",r=setTimeout(()=>h.style.display="block",6e4)}),i[0].addEventListener("keyup",e=>{13!=e.keyCode&&(i[0].setCustomValidity(""),i[0].classList.remove("error-input"))}),document.querySelector(".send-tel").addEventListener("click",(function(){let e=i[0].value;(""==e||e.includes("_"))&&(i[0].classList.add("error-input"),i[0].setCustomValidity(i[0].getAttribute("data-valid-massadge")))}),!1),e.addEventListener("submit",(function(e){e.preventDefault();let t=i[0].value;if(""!==t&&!t.includes("_")&&""==i[1].value){let e=t.replace("(","").replace(")","");o={phone:e},document.querySelector(".send-tel").disabled=!0,q(o,u,i[0])}})),l.addEventListener("submit",(function(e){e.preventDefault();let l=t[0].value;if(6==l.length&&""==t[1].value){!async function(e){$.ajax({url:"index.php?route=account/login/turboSmsCheckCode",type:"post",data:e,dataType:"json",beforeSend:function(){a(document.querySelector(".spinner-code"),"inline",t[0].parentNode),document.querySelector(".send-code-btn").disabled=!0},success:function(e){!0===e.code_matching&&!1===e.is_auth&&c?(d.style.display="none",p.classList.toggle("show-effect"),document.getElementById("telephone").value=e.telephone,document.getElementById("codePerson").value=e.code):!1===e.code_matching&&e.try_count<=5||!0===e.is_auth&&!1===e.code_matching&&e.try_count<=5?(document.querySelector(".send-code-btn").removeAttribute("disabled"),a(t[0].parentNode,"flex",document.querySelector(".spinner-code")),t[0].classList.add("error-input"),t[0].nextElementSibling.classList.add("error-label"),setTimeout(()=>{t[0].classList.remove("error-input"),t[0].nextElementSibling.classList.remove("error-label")},5e3),document.querySelector(".code-error-block").textContent=e.code_error):!1===e.code_matching&&e.try_count>5||!0===e.is_auth&&!1===e.code_matching&&e.try_count>5?(a(t[0].parentNode,"flex",document.querySelector(".spinner-code")),document.querySelector(".send-code-btn").removeAttribute("disabled"),t[0].classList.add("error-input"),t[0].nextElementSibling.classList.add("error-label"),setTimeout(()=>{t[0].classList.remove("error-input"),t[0].nextElementSibling.classList.remove("error-label")},5e3),document.querySelector(".code-error-block").textContent=e.try_error,h.style.display="block"):!0===e.is_auth&&!0===e.code_matching?(document.querySelector(".location-login").value=s,document.getElementById("codeForm").submit()):!1!==e.is_auth||c||(a(t[0].parentNode,"flex",document.querySelector(".spinner-code")),a(document.querySelector(".code__container-title-error"),"block",t[0].parentNode),clearTimeout(r),h.style.display="none",document.querySelector(".code-error-block").textContent="")},error:function(e){throw a(t[0].parentNode,"flex",document.querySelector(".spinner-code")),document.querySelector(".send-code-btn").removeAttribute("disabled"),t[0].classList.add("error-input"),t[0].nextElementSibling.classList.add("error-label"),setTimeout(()=>{t[0].classList.remove("error-input"),t[0].nextElementSibling.classList.remove("error-label")},5e3),new Error(e)}})}({sms_code:l,opencart_code:n,phone:o})}}))}async function S(){$.ajax({url:"index.php?route=account/login/turboSmsClearAttemps",type:"post",data:o,dataType:"json",success:function(){t[0].value=""},error:function(e){throw new Error(e)}})}async function q(e,t,o=null){$.ajax({url:"index.php?route=account/login/turboSmsGetCode",type:"post",data:e,dataType:"json",beforeSend:function(){a(t,"inline",o)},success:function(l){if(!0===l.send_sms&&o)_.style.display="none",g.style.display="block",b.textContent="+"+l.phone,n=l.send_code,e=l.phone,s=l.location,r=setTimeout(()=>h.style.display="block",6e4),a(o,"block",t);else if(!0===l.send_sms&&!o){a(t,"none",null),document.querySelector("#telephoneInform").setAttribute("readonly",!0),document.querySelector(".modal__inform-wrapper").style.display="block",n=l.send_code,e=l.phone,refreshTimeoutModal=setTimeout(()=>document.querySelector(".modal__refresh-code").style.display="block",6e4)}},error:function(e){if(o)o.classList.add("error-input"),setTimeout(()=>o.classList.remove("error-input"),5e3),document.querySelector(".send-tel").removeAttribute("disabled"),a(o,"block",t);else if(!o){document.querySelector(".modal__inform-inform-tel").removeAttribute("disabled"),a(t,"none",null);let e=document.querySelector("#telephoneInform");e.classList.add("error-input"),setTimeout(()=>e.classList.remove("error-input"),5e3)}throw new Error(e)}})}if(c){let t=document.querySelector("#personal-data");t.addEventListener("submit",(function(o){o.preventDefault(),""==t.querySelector('input[name="chekoutPersone"]').value&&(e(),setTimeout(()=>{t.submit()},200))}))}if(m){let e=document.querySelector(".backpacks-js"),t=document.querySelector(".handbags-js"),o=document.querySelector(".accessories-js"),n=document.querySelector("body"),r=document.querySelector(".menu__mobile-wrapper");m.addEventListener("click",e=>{y.classList.toggle("active-modal"),n.classList.toggle("body-not-scroll"),l()}),document.addEventListener("click",(function(i){let s=i.target;(s.classList.contains("active-modal")||s.classList.contains("menu__mobile-close"))&&(y.classList.toggle("active-modal"),n.classList.toggle("body-not-scroll"),l()),(s.classList.contains("backpacks-js")||s.parentNode.classList.contains("backpacks-js"))&&e.querySelector(".menu__mob-sub-wrapper").classList.toggle("show-effect"),(s.classList.contains("handbags-js")||s.parentNode.classList.contains("handbags-js"))&&t.querySelector(".menu__mob-sub-wrapper").classList.toggle("show-effect"),(s.classList.contains("accessories-js")||s.parentNode.classList.contains("accessories-js"))&&o.querySelector(".menu__mob-sub-wrapper").classList.toggle("show-effect"),s.classList.contains("menu__mob-sub-title")&&s.parentNode.classList.toggle("show-effect"),r.querySelector(".show-effect")?r.classList.add("body-not-scroll"):r.classList.remove("body-not-scroll")}))}}(),
//! SWIPERs
